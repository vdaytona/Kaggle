'''
Example code from https://www.kaggle.com/neilsummers/predict-west-nile-virus/west-nile-heatmap-by-year by Neil Summer
...
mapdata = np.loadtxt("./inputData/mapdata_copyright_openstreetmap_contributors.txt")
traps = pd.read_csv('./inputData/train.csv', parse_dates=['Date'])[['Date', 'Trap','Longitude', 'Latitude', 'WnvPresent']]
